...
ALTER TABLE VENDAS ADD APAGAR VARCHAR(10);
ALTER TABLE VENDAS MODIFY APAGAR INT;
ALTER TABLE VENDAS CHANGE APAGAR APAGADO INT;
ALTER TABLE VENDAS DROP COLUMN APAGADO;

ALTER TABLE PAGAMENTOS ADD APAGAR VARCHAR(10);
ALTER TABLE PAGAMENTOS MODIFY APAGAR INT;
ALTER TABLE PAGAMENTOS CHANGE APAGAR APAGADO INT;
ALTER TABLE PAGAMENTOS DROP COLUMN APAGADO;
...
ALTER TABLE PRODUTOS_VENDAS ADD APAGAR VARCHAR(10);
ALTER TABLE PRODUTOS_VENDAS MODIFY APAGAR INT;
ALTER TABLE PRODUTOS_VENDAS CHANGE APAGAR APAGADO INT;
ALTER TABLE PRODUTOS_VENDAS DROP COLUMN APAGADO;
