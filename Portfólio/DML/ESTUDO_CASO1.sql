...
DELETE FROM FORNECEDORES WHERE FORN_COD = 6;
...
DELETE FROM FILIAIS WHERE FILIAIS_COD = 6;
...
DELETE FROM PEDIDOS WHERE PEDIDOS_COD = 6;
...
DELETE FROM PEDIDOS_PRODUTOS WHERE PEPR_PEDIDOS = 6;
...
DELETE FROM FILIAIS_PRODUTOS WHERE FIPR_FILIAIS = 6;
...
DELETE FROM FORNECEDORES_PRODUTOS WHERE FOPR_FORN = 6;