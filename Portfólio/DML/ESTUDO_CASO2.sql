...
UPDATE PASSAGEIROS SET PASS_TEL = '(27) 91234-5678' WHERE PASS_CPF = '123.456.789-00';
UPDATE PASSAGEIROS SET PASS_EMAIL = 'nao.sei@exemple.com' WHERE PASS_CPF = '123.456.789-01';

DELETE FROM PASSAGEIROS WHERE PASS_CPF = '123.456.789-05';
...
UPDATE AEROPORTOS SET AEROP_LONGITUDE = -46.469511 WHERE AEROP_COD = 1;
UPDATE AEROPORTOS SET AEROP_LATIDUDE = -15.871111 WHERE AEROP_COD = 2;

DELETE FROM AEROPORTOS WHERE AEROP_COD = 6;
...
UPDATE AERONAVES SET AERON_CAPAC = 161 WHERE AERON_PREFIXO = 'PR-GUI';
UPDATE AERONAVES SET AERON_CAPAC = 179 WHERE AERON_PREFIXO = 'PT-MZO';

DELETE FROM AERONAVES WHERE AERON_PREFIXO = 'AB-CDE';
...
UPDATE VOOS SET VOO_AEROP_DESTINO = 3 WHERE VOO_ID = 1;
UPDATE VOOS SET VOO_DATA = '2024-11-17' WHERE VOO_ID = 2;
...
UPDATE FUNCIONARIOS SET FUNC_FUNCAO = 'Zelador' WHERE FUNC_ID = 1;
UPDATE FUNCIONARIOS SET FUNC_NOME = 'Felipe S. Machado' WHERE FUNC_ID = 2;
...
UPDATE RESERVAS SET RESERVA_VOO = 2 WHERE RESERVA_COD = 1;
UPDATE RESERVAS SET RESERVA_VOO = 1 WHERE RESERVA_COD = 2;

DELETE FROM RESERVAS WHERE RESERVA_COD = 6;
...
UPDATE EQUIPES SET EQ_VOO = 2 WHERE EQ_FUNC = 1;
UPDATE EQUIPES SET EQ_VOO = 1 WHERE EQ_FUNC = 2;

DELETE FROM EQUIPES WHERE EQ_FUNC = 6;